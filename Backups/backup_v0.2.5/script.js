    ...
    assetCategoryOrder.forEach(category => {
        ...
        addRow.innerHTML = `
            ...
            <td class="action-cell category-add-cell">
                <button type="button" class="add-category-item-btn-bottom" onclick="addAssetRowToCategory('${category}')" title="Add Item to ${category}">+</button>
            </td>
        `;
...
function renderLiabilityTable() {
    ...
    liabilityCategoryOrder.forEach(category => {
        ...
        addRow.innerHTML = `
            ...
            <td class="value-cell"></td>
            <td class="action-cell category-add-cell">
                <button type="button" class="add-category-item-btn-bottom" onclick="addLiabilityRowToCategory('${category}')" title="Add Item to ${category}">+</button>
            </td>
        `;
        tableBody.appendChild(addRow);
    });
...
function renderRealEstateTable() {
    ...
    addRow.innerHTML = `
        ...
        <td class="action-cell category-add-cell">
            <button type="button" class="add-category-item-btn-bottom" onclick="addRealEstateRow()" title="Add Real Estate Property">+</button>
        </td>
    `;
    tableBody.appendChild(addRow);
}
...
function calculateNetWorth() {
    ...
    if (totalLiabilitiesEl) {
        ...
        totalLiabilitiesEl.textContent = formatNetWorthCurrency(liabilitiesOnly);
    }
    if (netWorthEl) {
    ...
    if (liabilitiesSectionTotalEl) {
        ...
        const liabilitiesOnly = totalLiabilities - realEstateLiabilities;
        liabilitiesSectionTotalEl.textContent = formatNetWorthCurrency(liabilitiesOnly);
    }
